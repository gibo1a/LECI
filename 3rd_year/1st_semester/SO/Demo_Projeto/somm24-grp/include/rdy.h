 ...
 *   <tr> <td> \c rdyInit() <td align="center"> 401 <td> 0 (trivial) <td> Opens the module
 *   <tr> <td> \c rdyTerm() <td align="center"> 402 <td> 2 (low) <td> Closes the module
 *   <tr> <td> \c rdyPrint() <td align="center"> 403 <td> 3 (low medium) <td> Prints the internal state of the module
 *   <tr> <td> \c rdyAdd() <td align="center"> 404 <td> 2 (low) <td> Add a new entry, based on scheduling policy
 *   <tr> <td> \c rdyFetch() <td align="center"> 405 <td> 2 (low) <td> Removes and return the entry
 *   </table>
 *
