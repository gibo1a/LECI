...
{
    SllNode *lista = NULL;
    lista = sllInsert(lista,1234,"ola");
    printf("%d",lista==NULL);
    lista = sllInsert(lista,4532,"adeus");
    lista = sllInsert(lista,66666,"khha");
    sllPrint(lista,stdout);
    lista = sllRemove(lista,1234);
    sllPrint(lista,stdout);
    lista = sllDestroy(lista);
    sllPrint(lista,stdout);
    exit(0);
