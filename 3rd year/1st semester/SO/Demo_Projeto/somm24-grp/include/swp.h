 ...
 *   <tr> <td> \c swpInsert() <td align="center"> 404 <td> 2 (low) <td> Append a new entry to the queue
 *   <tr> <td> \c swpFetch() <td align="center"> 406 <td> 3 (low medium) <td> 
 *   </table>
 *
 ...
 * \details
 *  - If the active policy is \c FirstProcess than remove the first entry in the list 
 *    if the value of field \c size is not bigger than the specified
 *  - If the active policy is \c FirstFitProcess than remove the first process that fits in the available memory
